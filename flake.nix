{
  ...
  outputs = { self, nixpkgs, ... }@inputs: let
    ...
    overlay-tangible = final: prev: {
      ...
      tangible-desktop-scripts = pkgs.callPackage ./pkgs/tangible-desktop-scripts.nix {};

      dwm-tangible = pkgs.callPackage ./pkgs/dwm-tangible.nix {};
      dwmblocks-tangible = pkgs.callPackage ./pkgs/dwmblocks-tangible.nix {};
      st-tangible = pkgs.callPackage ./pkgs/st-tangible.nix {};
      dmenu-tangible = pkgs.callPackage ./pkgs/dmenu-tangible.nix {};
    };
